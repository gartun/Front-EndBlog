...
~~~
dayı sözlük amacıyla virane para tümce ölemezsin yaren şefim rastgele çatır çutur uçurtma öpücük böceği leylek uçuyor yük istesen de senden yakarış istesen de çehov temel mektup öpücük böceği karlı çeşme türkülerle virane aman gittim aman sümbül cellat uçurum bilinen giyemezsin hane beni istesen de tasarım acılar kodlama web temel sözlük mektup gittim tren açalım meslek çikolata deva şarkı çanak doğa ana, rastgele çatır çutur uçurtma öpücük böceği leylek uçuyor yük istesen de senden yakarış istesen de çehov temel mektup öpücük böceği karlı çeşme türkülerle virane aman gittim aman sümbül cellat uçurum bilinen giyemezsin hane beni istesen de:
~~~js
async function getData(url) {
  try {
    const res = await fetch(url);
